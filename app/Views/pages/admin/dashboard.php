            ...
            <a href="<?= base_url() ?>/admin/leave" class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
               <div class="flex items-center">
                  <div class="flex-shrink-0">
                     ...
                     <h3 class="text-base font-normal text-gray-500">Leave Requests</h3>
                  </div>
         ...
         <div class="w-full ">
            ...
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
               <?php if (count($on_leave_today) == 0) { ?>
                  <h3 class="text-xl leading-none font-bold text-center text-gray-900">Everyone is at work!</h3>
               <?php } else { ?>
                  <h3 class="text-xl leading-none font-bold text-gray-900 mb-10">
                     <?= count($on_leave_today) ?> people on Leave Today
                  </h3>
                  <div class="block w-full overflow-x-auto">
                     <table class="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                           <?php foreach ($on_leave_today as $employee) { ?>
