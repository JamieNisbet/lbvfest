    ...
    <div class="bg-blue-500">
        <div class="flex justify-center container mx-auto my-auto w-screen h-screen items-center flex-col">
            <div class="text-slate-100 items-center">
                <h1 class="text-center text-2xl pb-3">
                    <?= $title ?>
                </h1>
            ...
            <div class="container max-w-full mx-auto py-24 px-6">
                    ...
                    <div class="max-w-sm mx-auto px-6">
                        <div class="relative flex flex-wrap">
                            <div class="w-full relative">
                                <div class="mt-6">
                                    <form class="mt-8" method="post" action="<?= base_url() ?>/login">
                                        <div class="mx-auto max-w-lg">
                                            <div class="py-2">
                                                <input placeholder="email address" type="text" name="username"
                                            ...
                                            <div class="py-2" x-data="{ show: true }">
                                                <div class="relative">
                                                    <input placeholder="******" :type="show ? 'password' : 'text'"
                                                        ...
                                                        value="<?= set_value('password') ?>" class="text-md block px-3 py-2 rounded-lg w-full 
                ...
                focus:outline-none">
                                            ...
                                            <div class="flex justify-between"> <label
                                                    class="block text-gray-500 font-bold my-4"><a
                                                        href="<?= base_url() ?>/forgot_password"
                                                        class="cursor-pointer tracking-tighter text-black border-b-2 border-gray-200 hover:border-gray-400"><span>Forgot
                                                            Password?</span></a></label></div> <input type="submit"
                                                value="Login" class="mt-3 text-lg font-semibold 
